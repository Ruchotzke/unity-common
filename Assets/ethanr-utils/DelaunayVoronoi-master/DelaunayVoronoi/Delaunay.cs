...
namespace UnityUtilities.DelaunayVoronoi
{
    public class DelaunayTriangulator
    {
        ...
        public IEnumerable<Point> GeneratePoints(List<Vector2> seedPoints, Rect bounds)
        {
            MaxX = bounds.xMax;
            MaxY = bounds.yMax;
            
            // TODO make more beautiful
            var point0 = new Point(bounds.xMin, bounds.yMin);
            var point1 = new Point(bounds.xMin, MaxY);
            var point2 = new Point(MaxX, MaxY);
            var point3 = new Point(MaxX, bounds.yMin);
            var points = new List<Point>() { point0, point1, point2, point3 };
            var tri1 = new Triangle(point0, point1, point2);
            var tri2 = new Triangle(point0, point2, point3);
            border = new List<Triangle>() { tri1, tri2 };
